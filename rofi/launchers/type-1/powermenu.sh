...
while true; do
    case "$1" in
        "-h"|"--help")
            ...
            echo "                       Nerdfonts collection. By default, they are shown" echo "  --[no-]text          Show text description or not." echo "  --symbols-font FONT  Use the given font for symbols. By default, the symbols"
